	...
	class MyHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 10:
				...
				break;
            case 11:
                doWork(getString(R.string.decompile_jar_finish), bundle);
                break;
			}
		}
	}
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							case 0:
								final String command = new String(
										" sh /data/data/per.pqy.apktool/mydata/apktool.sh d -f ")
										+ "'"
										+ uri
										+ "' -o '"
							...
							case 1:
								final String command1 = new String(
										" sh /data/data/per.pqy.apktool/mydata/apktool.sh d -f -r ")
										+ "'"
										+ uri
										+ "' -o '"
										+ uri.substring(0, uri.length() - 4)
							...
							case 2:
								final String command2 = new String(
										" sh /data/data/per.pqy.apktool/mydata/apktool.sh d -f -s ")
										+ "'"
										+ uri
										+ "' -o '"
										+ uri.substring(0, uri.length() - 4)
							...
							case 3:
								final String command3 = new String(
										" sh /data/data/per.pqy.apktool/mydata/signapk.sh ")
										+ "'"
										+ uri
										+ "' '"
										+ uri.substring(0, uri.length() - 4)
							...
							case 4:
								final String command4 = new String(
										" /data/data/per.pqy.apktool/lix/dexopt-wrapper ")
										+ "'"
										+ uri
										+ "' '"
							...
							case 5:
								final String command5 = new String(
										" /data/data/per.pqy.apktool/lix/zipalign -f -v 4 ")
										+ "'"
										+ uri
										+ "' '"
										+ uri.substring(0, uri.length() - 4)
							...
							case 7:
								final String command7 = new String(
										"/data/data/per.pqy.apktool/lix/7z d -tzip '")
										+ uri + "' classes.dex";
								threadWork(MainActivity.this,
							...
							case 8:
								...
								if (!new File(f.getParent() + "/META-INF")
									...
									final String command8 = new String(
											"sh /data/data/per.pqy.apktool/mydata/tool.sh ")
											+ "'"
											+ f.getParent()
											+ "' '"
											+ f.getName() + "'";
							...
							case 11:
								final String command11 = new String(
										" sh /data/data/per.pqy.apktool/mydata/apktool.sh if ")
										+ "'" + uri + "'";
								threadWork(
										MainActivity.this,
							...
							case 12:
								if(uri.endsWith(".apk")){
								final String command12 = new String(" sh /data/data/per.pqy.apktool/mydata/dex2jar/d2j-dex2jar.sh ")
								+ "'"
								+uri
								+"' -o '"
								+uri.substring(0,uri.length()-3)
								+"jar'";
								threadWork(MainActivity.this,getString(R.string.making),command12,6);
								}
								break;
							case 13:
								if(uri.endsWith(".jar")){
									final String command13 = new String(" sh /data/data/per.pqy.apktool/mydata/dex2jar/d2j-jar2dex.sh ")
									+ "'"
									+uri
									+"' -o '"
									+uri.substring(0,uri.length()-3)
									+"dex'";
									threadWork(MainActivity.this,getString(R.string.making),command13,6);
									}
									break;
                            case 14:
							    if(uri.endsWith(".jar")){
                                    final String command14 = new String(" sh /data/data/per.pqy.apktool/mydata/jd-core.sh ")
                                            + "'"
                                            +uri
                                            +"' -oz '"
                                            +uri.substring(0,uri.length()-3)
                                            +"jd.zip'";
									threadWork(MainActivity.this,getString(R.string.decompiling),command14,11);
									}
									break;
                            case 15:
                                if(uri.endsWith(".jar")){
                                    final String command15 = new String(" sh /data/data/per.pqy.apktool/mydata/cfr.sh ")
                                            + "'"
                                            +uri
                                            +"' --rename 1 --outputdir '"
                                            +uri.substring(0,uri.length()-3)
                                            +"cfr'";
                                    threadWork(MainActivity.this,getString(R.string.decompiling),command15,11);
                                }
                                break;
                            case 16:
                                if(uri.endsWith(".jar")){
                                    final String command16 = new String(" sh /data/data/per.pqy.apktool/mydata/procyon.sh ")
                                            + "'"
                                            +uri
                                            +"' -o '"
                                            +uri.substring(0,uri.length()-3)
                                            +"procyon'";
                                    threadWork(MainActivity.this,getString(R.string.decompiling),command16,11);
                                }
                                break;
                            case 17:
                                if(uri.endsWith(".jar")){
                                    final String command17 = new String(" sh /data/data/per.pqy.apktool/mydata/fernflower.sh ")
                                            + "'"
                                            +uri
                                            +"' '"
                                            +uri.substring(0,uri.length()-3)
                                            +"fernflower'";
                                    threadWork(MainActivity.this,getString(R.string.decompiling),command17,11);
                                }
                                break;
							case 18:
								if(uri.endsWith(".jar") || uri.endsWith(".apk")){
									final String command18 = new String(" sh /data/data/per.pqy.apktool/mydata/jadx.sh ")
											+ "'"
											+uri
											+"' -d '"
											+uri.substring(0,uri.length()-3)
											+"jadx'";
									threadWork(MainActivity.this,getString(R.string.decompiling),command18,11);
								}
								break;
							case 19:
								if(uri.endsWith(".jar")){
		...
		new Thread() {
			public void run() {
				if (!(new File("/data/data/per.pqy.apktool/lix").exists())) {
					RunExec.Cmd(
							shell,
							"dd if=/data/data/per.pqy.apktool/mydata/busybox of=/data/data/per.pqy.apktool/tar");
					RunExec.Cmd(shell,
							"chmod 777 /data/data/per.pqy.apktool/tar");
					RunExec.Cmd(
							shell,
							"/data/data/per.pqy.apktool/tar xf /data/data/per.pqy.apktool/mydata/jvm.tar --directory=/data/data/per.pqy.apktool");
					RunExec.Cmd(shell,
